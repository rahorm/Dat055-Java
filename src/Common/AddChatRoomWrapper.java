...
//
//**
// * thoughts: this is just a string now so why have a wrpper. <-- Håller med, har dock ändrat i ServerConn
// * för detta nu för samtliga, så om det ändras tillbaka ändra även där /Mona
// *
